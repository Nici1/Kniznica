    ...
    public void go (){
        ...
        button1.addActionListener(new Action() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                area.setText(DatabaseConnectionISv2021.VsiIzposoje().get(0)+"\n");



                for (int i=1; i<DatabaseConnectionISv2021.VsiIzposoje().size();i++) {

                    area.append(DatabaseConnectionISv2021.VsiIzposoje().get(i)+"\n");
                }
            }
        });
