...
public class SpregledAKZ {
    ...
    public void go (){
        ...
        label[0].setText("AvtorID | Ime Avtorja | Priimek Avtorja | KnjigaID | Ime | Zvrst | Leto Izdaje | Stevilo Izvodov");
        mpanel.add(label[0]);
        ...
        button1.addActionListener(new Action() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                area.setText(DatabaseConnectionISv2021.AvtorKnjigaZvrst().get(0)+"\n");



                for (int i=1; i<DatabaseConnectionISv2021.AvtorKnjigaZvrst().size();i++) {

                    area.append(DatabaseConnectionISv2021.AvtorKnjigaZvrst().get(i)+"\n");
                }
            }
        });
